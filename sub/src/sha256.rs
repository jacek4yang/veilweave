// Pure-Rust SHA-256 (FIPS 180-4). Ported verbatim from veilweave / veilweave-tools
// so the UUID codec in this subscription worker is bit-for-bit compatible with
// the relay's decoder.
